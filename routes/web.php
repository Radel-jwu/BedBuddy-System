...
Route::get('/properties/search', [DashboardController::class, 'search']);
Route::get('/properties/map', [DashboardController::class, 'map']);


//Post Route
Route::middleware(['auth'])->group(function () {
    Route::get('/socials', [PostController::class, 'index'])->name('socials.index');
    Route::post('/socials', [PostController::class, 'store'])->name('socials.store');
});
