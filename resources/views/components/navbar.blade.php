...
<!-- Navbar Layout -->
<header class="flex justify-between items-center bg-white px-8 py-4 shadow-md fixed top-0 w-full z-50">
    <!-- Logo -->
    ...
    <div class="flex items-center space-x-4">
        ...
        <div class="flex items-center space-x-2">
            ...
            <img src="{{ asset('images/' . $user->profile_pic ?? 'images/default-avatar.jpg') }}" alt="Avatar" class="w-10 h-10 rounded-full border" />
